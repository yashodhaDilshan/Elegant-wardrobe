	...
	<div class="Main-div"> <!-- wrap div -->
		...
		<div class="heding" id="heding">	
		  ...
		  <div class="site-name" id="Hedimg">  <!--heding div 1-->				 
			...
			<div class="search" id="search">  <!--heding div 1--> <!-- search Start-->			 
				<form action="php/View_Search_Home.php" method="get">				
					<div class="s-box">					
			...
			<div class="list">  <!--heding div 2--> <!--list Start-->
				<ul><b>
					...
					<li><a href="php/Login.php">Login</a></li></b>
					<li></li></b>
				</ul>
			</div><!--list end-->
		...
		<div class="products">
			...
			<div class="procut-item">
					<div class="p1">
						<a href="php/View_Women_Item_user.php">
						<img src="image/Admin/Admin1.jpg"></a>
					</div>
					
					<div class="p2">
						<a href="php/View_men_Item_user.php">
						<img src="image/Admin/Admin2.jpg"></a>
					</div>
					
					<div class="p3">
						<a href="php/View_kid_Item_user.php">
