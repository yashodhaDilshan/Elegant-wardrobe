	...
	if(isset($_POST['submit']))  // associative array
	{
		...
		else
	    {
		     ...
		     {
			      $sql = "INSERT INTO signup(name,password,email,type) VALUES('$name','$password','$email','admin')";		
...
<title>Add_item</title>
	<link rel="stylesheet" type="text/css" href="../css/Signup-admin.css">
...
<body>
	<div class="main-box">		
		...
		<form action="Signup-admin.php" method="post" enctype="multipart/form-data">	
