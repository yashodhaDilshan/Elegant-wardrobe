...
<title>Men item</title>
	<link rel="stylesheet" type="text/css" href="../css/Men_Item_user.css">
</head>
	...
	<div class="Main-div">
		...
		<div class="heding" id="heding">	
		  ...
		  <div class="site-name" id="Hedimg">  <!--heding div 1-->				 
			...
			<div class="search" id="search">  <!--heding div 1--> <!-- search Start-->		
				<form action="View_Search_user.php" method="get">				
					<div class="s-box">					
						<div class="box-s1"><!-- Search box view-->	
							<input class="search-btn" type="button" id="submit" style="margin-left: 30px;"> <!--search-box-->	
							<input class="search-box" name="search" type="text" placeholder=" Insert Name and Press Enter" autofocus>					<input type="hidden" name="Table" Value="<?php echo "men_item";?>">	
			...
			<div class="list">  <!--heding div 2--> <!--list Start-->
				<ul><b>
					<li><a href="../Home_page.php" style="font-size: 30px; margin-right: 30px;">Home</a></li>				
		...
		<div class="main-box"> <!--main box-->
			...
			<div class="nav">	
				...
				<div class="women"><a href="View_Women_Item_user.php"><h1>Women</h1></a></div>
				
				<div class="men">
					<div class="men-menu"><a href="View_men_Item_user.php"><h1>Men</h1></a></div>
				...
				<div class="kid"><a href="View_kid_Item_user.php"><h1>Kid</h1></a></div>
