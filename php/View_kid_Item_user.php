...
<head>
<meta charset="utf-8">
<title>Kid item</title>
	<link rel="stylesheet" type="text/css" href="../css/kid_Item_user.css">
</head>
	...
	<div class="Main-div">
				...
				<form action="View_Search_user.php" method="get">				
					<div class="s-box">					
						<div class="box-s1"><!-- Search box view-->	
							...
							<input type="hidden" name="Table" Value="<?php echo "kid_item";?>">	
		...
		<div class="main-box"> <!--main box-->
			...
			<div class="nav">	
				...
				<div class="men"><a href="View_men_Item_user.php"><h1>Men</h1></a></div>
				
				<div class="kid">
					<div class="kid-menu"><a href="View_Item_user.php"><h1>Kid</h1></a></div>
